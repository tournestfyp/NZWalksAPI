    ...
    public partial class Seedingdatafordifficultiesandregions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("599e663a-34d0-4dfa-bd33-2d2e29ff7a8b"), "Medium" },
                    { new Guid("b9ea6a69-f82a-47ca-a08f-e3539f88dcf7"), "Hard" },
                    { new Guid("febd9d53-3090-4fd7-9563-f60853ae64fb"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("599e663a-34d0-4dfa-bd33-2d2e29ff7a8b"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("b9ea6a69-f82a-47ca-a08f-e3539f88dcf7"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("febd9d53-3090-4fd7-9563-f60853ae64fb"));
